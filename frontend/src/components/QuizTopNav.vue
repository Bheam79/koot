...
// Sub-nav used by the dashboard / editor screens. The main header in App.vue still
// renders the global brand + auth links; this is a contextual bar underneath it.
